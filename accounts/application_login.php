...
$origin  = array_get($_GET, 'destination', '');

$header_args = [
    "js_files" => [
        "$code_url/scripts/api.js",
        "$code_url/scripts/login.js",
    ],
    "js_data" => "
...
slim_header(_("Login Page"), $header_args);

echo "<label for='loginform-userNM'>" . _("ID") . ":</label> <input type='text' id='loginform-userNM' id='userNM' size='10' maxlength='50'>&nbsp;
    <label for='loginform-userPW'>" . _("Password") . ":</label> <input type='password' id='loginform-userPW' name='userPW' size='10' maxlength='50'>&nbsp;
    <input type='button' onclick='signIn();' value='" . _("Sign In") ."'>";
