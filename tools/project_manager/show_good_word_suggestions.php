...
if ($timeCutoff == $fileObject->mod_time) {
    echo "selected";
}
echo ">" . _("Suggestions since Good Words List was saved") . "</option>";
$timeCutoffOptions = [1, 2, 3, 4, 5, 6, 7, 14, 21];
...
function _get_word_list($projectid, $timeCutoff)
{
    ...
    return [$all_suggestions_w_freq, $all_suggestions_w_occurrences, $round_suggestions_w_freq, $round_suggestions_w_occurrences, $rounds, $round_page_count, $messages];
}
